...
void main()
{
    ...
    oNormal = TESS_ALPHA*pnNormal + (1.0-TESS_ALPHA) * barNormal;
    ...
    vec3 finalPos = (1.0-TESS_ALPHA)*barPos + TESS_ALPHA*pnPos;
 gl_Position   = ubo.projection * ubo.view * ubo.model * vec4(finalPos,1.0);
}