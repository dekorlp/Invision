...
namespace Invision
{
	...
	VulkanBaseShader::VulkanBaseShader(const SVulkanBase& vulkanInstance, const std::vector<char>& code, VkShaderStageFlagBits stage)
	{
	...
	void VulkanBaseShader::Destroy(const SVulkanBase& vulkanInstance)
	{
