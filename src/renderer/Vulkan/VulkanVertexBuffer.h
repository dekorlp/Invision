...
namespace Invision
{
	...
	public:
		...
		INVISION_API VulkanVertexBuffer& CreateVertexBuffer(const SVulkan &vulkanInstance, VulkanCommandPool commandPool, VkDeviceSize size, const void* source, VkDeviceSize offset);
