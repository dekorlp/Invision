...
namespace Invision
{
	...
	public:
		...
		INVISION_API virtual IUniformBuffer& CreateImageBinding(uint32_t binding, uint32_t descriptorCount, ShaderStage shaderStage, std::shared_ptr < Invision::ITexture> texture) = 0;
