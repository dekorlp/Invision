...
namespace Invision
{
	...
	public:
		...
		//INVISION_API virtual IVertexBuffer& CreateVertexBuffer() = 0;
		INVISION_API virtual std::shared_ptr < IBindingDescription> CreateVertexBinding(uint32_t binding, uint64_t size, const void *source, uint32_t stride, VertexInputRate vertexInputRate) = 0;
