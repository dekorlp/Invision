...
namespace Invision
{
	...
	public:
		...
		INVISION_API VulkanBaseIndexBuffer& CreateIndexBuffer(const SVulkanBase &vulkanInstance, VulkanBaseCommandPool commandPool, VkDeviceSize size, const void* source, VkDeviceSize offset);
