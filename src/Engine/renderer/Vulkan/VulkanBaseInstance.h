...
namespace Invision
{
	...
	public:
		...
		INVISION_API SVulkanBase Init(const char* appName, const char* engineName, const uint32_t appVersion, const uint32_t engineVersion, const std::vector<const char*> &extensions, bool debug = false);
