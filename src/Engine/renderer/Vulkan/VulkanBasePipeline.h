...
namespace Invision
{
	...
	public:
		...
		void INVISION_API SetRenderPropertyPrimitiveTopology(VkPrimitiveTopology primitiveTopology);
		void INVISION_API SetRenderPropertyPolygonMode(VkPolygonMode polygonMode);
		void INVISION_API SetRenderPropertyCullMode(VkCullModeFlags cullModeFlags);
		void INVISION_API SetRenderPropertyFrontFace(VkFrontFace frontFace);
		void INVISION_API SetRenderPropertyLineWidth(float lineWidth);
