...
namespace Invision
{
	...
	enum PrimitiveTopology
	{
		...
		PRIMITIVE_TOPOLOGY_1_CONTROL_POINT_PATCHLIST = 101,
		PRIMITIVE_TOPOLOGY_2_CONTROL_POINT_PATCHLIST = 102,
		PRIMITIVE_TOPOLOGY_3_CONTROL_POINT_PATCHLIST = 103,
		PRIMITIVE_TOPOLOGY_4_CONTROL_POINT_PATCHLIST = 104,
		PRIMITIVE_TOPOLOGY_5_CONTROL_POINT_PATCHLIST = 105,
		PRIMITIVE_TOPOLOGY_6_CONTROL_POINT_PATCHLIST = 106,
		PRIMITIVE_TOPOLOGY_7_CONTROL_POINT_PATCHLIST = 107,
		PRIMITIVE_TOPOLOGY_8_CONTROL_POINT_PATCHLIST = 108,
		PRIMITIVE_TOPOLOGY_9_CONTROL_POINT_PATCHLIST = 109,
		PRIMITIVE_TOPOLOGY_10_CONTROL_POINT_PATCHLIST = 110,
		PRIMITIVE_TOPOLOGY_11_CONTROL_POINT_PATCHLIST = 111,
		PRIMITIVE_TOPOLOGY_12_CONTROL_POINT_PATCHLIST = 112,
		PRIMITIVE_TOPOLOGY_13_CONTROL_POINT_PATCHLIST = 113,
		PRIMITIVE_TOPOLOGY_14_CONTROL_POINT_PATCHLIST = 114,
		PRIMITIVE_TOPOLOGY_15_CONTROL_POINT_PATCHLIST = 115,
		PRIMITIVE_TOPOLOGY_16_CONTROL_POINT_PATCHLIST = 116,
		PRIMITIVE_TOPOLOGY_17_CONTROL_POINT_PATCHLIST = 117,
		PRIMITIVE_TOPOLOGY_18_CONTROL_POINT_PATCHLIST = 118,
		PRIMITIVE_TOPOLOGY_19_CONTROL_POINT_PATCHLIST = 119,
		PRIMITIVE_TOPOLOGY_20_CONTROL_POINT_PATCHLIST = 120,
		PRIMITIVE_TOPOLOGY_21_CONTROL_POINT_PATCHLIST = 121,
		PRIMITIVE_TOPOLOGY_22_CONTROL_POINT_PATCHLIST = 122,
		PRIMITIVE_TOPOLOGY_23_CONTROL_POINT_PATCHLIST = 123,
		PRIMITIVE_TOPOLOGY_24_CONTROL_POINT_PATCHLIST = 124,
		PRIMITIVE_TOPOLOGY_25_CONTROL_POINT_PATCHLIST = 125,
		PRIMITIVE_TOPOLOGY_26_CONTROL_POINT_PATCHLIST = 126,
		PRIMITIVE_TOPOLOGY_27_CONTROL_POINT_PATCHLIST = 127,
		PRIMITIVE_TOPOLOGY_28_CONTROL_POINT_PATCHLIST = 128,
		PRIMITIVE_TOPOLOGY_29_CONTROL_POINT_PATCHLIST = 129,
		PRIMITIVE_TOPOLOGY_30_CONTROL_POINT_PATCHLIST = 130,
		PRIMITIVE_TOPOLOGY_31_CONTROL_POINT_PATCHLIST = 131,
		PRIMITIVE_TOPOLOGY_32_CONTROL_POINT_PATCHLIST = 132,
	};
	...
	public:
		 ...
		 INVISION_API virtual std::shared_ptr<IGraphicsInstance> CreateInstance(CanvasDimensions canvas, std::shared_ptr <Invision::IRenderPass>& renderPass, std::shared_ptr <Invision::IFramebuffer>& framebuffer, std::shared_ptr <Invision::ICommandBuffer>& commandBuffer, MSAAMode msaaMode = MSAAMode::MSAAMODE_SAMPLE_COUNT_BEST) = 0;
